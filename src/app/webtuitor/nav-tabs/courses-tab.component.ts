...
@Component({
    ...
    <div class="card-group">
        <div [routerLink]="['/courses/',course.link]" *ngFor="let course of courses | slice:0:4; let i=index" class="card">
        ...
        <div class="card-body">
            ...
            <button [routerLink]="['/courses/',course.link]" class="btn btn-md btn-outline-info">Start</button>
            <p class="card-text">
