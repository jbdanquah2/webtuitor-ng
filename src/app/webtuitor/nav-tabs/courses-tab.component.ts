...
@Component({
    ...
    <div class="card-group">
        <div [routerLink]="['/course/',course.id]" *ngFor="let course of courses" class="card">
        ...
        <div class="card-body">
            ...
            <button [routerLink]="['/course/',course.id]" class="btn btn-md btn-outline-info">Start</button>
            <p class="card-text">
